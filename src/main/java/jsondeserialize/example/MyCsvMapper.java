...
/**
 * Added change requested by @cowtowncoder for testing
 */
public class MyCsvMapper extends ObjectMapper
{
     ...
     * @since 2.10
     */
    public static class Builder extends MapperBuilder<MyCsvMapper, Builder>
    {
        public Builder(MyCsvMapper m) {
            super(m);
        }
    ...
    public MyCsvMapper(CsvFactory f)
    {
        super(f);
     ...
     * @since 2.5
     */
    protected MyCsvMapper(MyCsvMapper src)
    {
        super(src);
        _untypedSchemas = new LRUMap<JavaType,CsvSchema>(8,32);
        _typedSchemas = new LRUMap<JavaType,CsvSchema>(8,32);
     ...
     * @since 2.10
     */
    public static MyCsvMapper.Builder csvBuilder() {
        return new MyCsvMapper.Builder(new MyCsvMapper());
    }

    /**
     * @since 2.10
     */
    public static MyCsvMapper.Builder builder() {
        return new MyCsvMapper.Builder(new MyCsvMapper());
    }
     ...
     * @since 2.10
     */
    public static MyCsvMapper.Builder builder(CsvFactory streamFactory) {
        return new MyCsvMapper.Builder(new MyCsvMapper(streamFactory));
    }
     ...
     */
    @Override
    public MyCsvMapper copy()
    {
        _checkInvalidCopy(MyCsvMapper.class);
        return new MyCsvMapper(this);
    }
    ...
    public MyCsvMapper configure(CsvGenerator.Feature f, boolean state) {
        return state ? enable(f) : disable(f);
    }

    public MyCsvMapper configure(CsvParser.Feature f, boolean state) {
        return state ? enable(f) : disable(f);
    }

    public MyCsvMapper enable(CsvGenerator.Feature f) {
        ((CsvFactory)_jsonFactory).enable(f);
        return this;
    }

    public MyCsvMapper enable(CsvParser.Feature f) {
        ((CsvFactory)_jsonFactory).enable(f);
        return this;
    }

    public MyCsvMapper disable(CsvGenerator.Feature f) {
        ((CsvFactory)_jsonFactory).disable(f);
        return this;
    }

    public MyCsvMapper disable(CsvParser.Feature f) {
        ((CsvFactory)_jsonFactory).disable(f);
        return this;
    }
            ...
            boolean typed, JavaType pojoType, NameTransformer unwrapper, Class<?> view)
    {
        ...
        BeanDescription beanDesc = getDeserializationConfig().introspect(pojoType);
